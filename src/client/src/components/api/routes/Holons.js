  ...
  update() {
    ...
    this.setState({
      schemaData: [
        ...
        ['daily_work_hours', ['number'], 'The daily work hours of holon. Calculated by dividing total weekly work hours with seven.', false, ['view', 'edit', 'embed']],
        ['latest_state', ['string (JSON)'], 'The latest_state of holon. Deprecated by September 2022.', true, ['view']],
        ...
        ['availability_data', ['string (JSON)'], 'The availability data of holon.', false, ['view', 'edit', 'embed']],
        ['load_data', ['string (JSON)'], 'The load data of holon.', false, ['view', 'edit', 'embed']],
        ['stress_data', ['string (JSON)'], 'The stress data of holon.', false, ['view', 'edit', 'embed']],
        ['cost_data', ['string (JSON)'], 'The cost data of holon.', false, ['view', 'edit', 'embed']],
        ['age', ['number'], 'The age of holon if the type of holon is employee.', false, ['view', 'edit', 'embed']],
        ['experience_years', ['number'], 'The total experience years of holon.', false, ['view', 'edit', 'embed']],
        ['created_on', ['string (JS Date)'], 'The exact time the holon was created.', true, ['view']],
        ['updated_on', ['string (JSDate)'], 'The latest time the holon was updated.', true, ['view']],
        ['created_by', ['string'], 'The ID of the user who created the holon.', true, ['view']],
        ['is_available', ['boolean'], 'Is holon available for allocation requests.', false, ['view', 'edit', 'embed']],
      ],
